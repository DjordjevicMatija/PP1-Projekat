...
public class MatchedIf extends MatchedStatement {

    private Condition Condition;
    private MatchedStatement MatchedStatement;
    private MatchedStatement MatchedStatement1;

    public MatchedIf (Condition Condition, MatchedStatement MatchedStatement, MatchedStatement MatchedStatement1) {
