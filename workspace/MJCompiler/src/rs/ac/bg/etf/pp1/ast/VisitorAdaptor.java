...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(MatrixAload MatrixAload) { visit(); }
    ...
    public void visit(DesignatorElement DesignatorElement) { visit(); }
    public void visit(MatrixFactor MatrixFactor) { visit(); }
    public void visit(MatrixMax MatrixMax) { visit(); }
    public void visit(FactorExpr FactorExpr) { visit(); }
    public void visit(NewClassFactor NewClassFactor) { visit(); }
    public void visit(NewMatrixFactor NewMatrixFactor) { visit(); }
    ...
    public void visit(DesingFuncFactor DesingFuncFactor) { visit(); }
    ...
    public void visit(NegativeTermList NegativeTermList) { visit(); }
    public void visit(TerminalList TerminalList) { visit(); }
    public void visit(SingleTerm SingleTerm) { visit(); }
    public void visit(PositiveTermList PositiveTermList) { visit(); }
    ...
    public void visit(NoActParameters NoActParameters) { visit(); }
    public void visit(ActParameters ActParameters) { visit(); }
    public void visit(NoConditionFactor NoConditionFactor) { visit(); }
    public void visit(ConditionFactor ConditionFactor) { visit(); }
    public void visit(DesignDec DesignDec) { visit(); }
    public void visit(DesignInc DesignInc) { visit(); }
    public void visit(DesingFunc DesingFunc) { visit(); }
    ...
    public void visit(NoLocalVarDeclarations NoLocalVarDeclarations) { visit(); }
    ...
    public void visit(FormParamElement FormParamElement) { visit(); }
    public void visit(SingleFormParam SingleFormParam) { visit(); }
    public void visit(FormParamList FormParamList) { visit(); }
    public void visit(NoMethodParameters NoMethodParameters) { visit(); }
    public void visit(ErrorMethodParameters ErrorMethodParameters) { visit(); }
