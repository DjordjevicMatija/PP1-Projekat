...
public class DesingActParsFactor extends Factor {

    private Designator Designator;
    private OptActPars OptActPars;

    public DesingActParsFactor (Designator Designator, OptActPars OptActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesingActParsFactor(\n");
